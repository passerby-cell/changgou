...
public class SpuController {
    ...
    public Result pullMany(@RequestBody Long[] id) {
        int i = spuService.pullMany(id);
        return new Result(true, StatusCode.OK, "商品批量下架成功", i);
    }
     ...
     */
    @PutMapping("/put/many")
    public Result putMany(@RequestBody Long[] id) {
        int i = spuService.putMany(id);
        return new Result(true, StatusCode.OK, "商品批量上架成功", i);
    }
